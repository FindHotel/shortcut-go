...
// WithDetail adds the detail to the search params
func (o *SearchParams) WithDetail(detail *string) *SearchParams {
	o.SetDetail(detail)
	return o
}

// SetDetail adds the detail to the search params
func (o *SearchParams) SetDetail(detail *string) {
	o.Detail = detail
}

// WithEntityTypes adds the entityTypes to the search params
func (o *SearchParams) WithEntityTypes(entityTypes []string) *SearchParams {
	o.SetEntityTypes(entityTypes)
	return o
}

// SetEntityTypes adds the entityTypes to the search params
func (o *SearchParams) SetEntityTypes(entityTypes []string) {
...
// WithPageSize adds the pageSize to the search params
func (o *SearchParams) WithPageSize(pageSize *int64) *SearchParams {
	o.SetPageSize(pageSize)
	return o
}

// SetPageSize adds the pageSize to the search params
func (o *SearchParams) SetPageSize(pageSize *int64) {
	o.PageSize = pageSize
}
...
// bindParamSearch binds the parameter entity_types
func (o *SearchParams) bindParamEntityTypes(formats strfmt.Registry) []string {
