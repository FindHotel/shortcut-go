...
type ClientService interface {
	...
	DeleteCustomField(params *DeleteCustomFieldParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DeleteCustomFieldNoContent, error)
	...
	GetCustomField(params *GetCustomFieldParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetCustomFieldOK, error)
	...
	SearchIterations(params *SearchIterationsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*SearchIterationsOK, error)
	...
	UpdateCustomField(params *UpdateCustomFieldParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateCustomFieldOK, error)
...
*/
func (a *Client) DeleteCustomField(params *DeleteCustomFieldParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DeleteCustomFieldNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
	...
	op := &runtime.ClientOperation{
		...
		Method:             "DELETE",
		PathPattern:        "/api/v3/custom-fields/{custom-field-public-id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
	...
	success, ok := result.(*DeleteCustomFieldNoContent)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for deleteCustomField: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
GetCustomField gets custom field
*/
func (a *Client) GetCustomField(params *GetCustomFieldParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetCustomFieldOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
/*
ListCustomFields lists custom fields
*/
func (a *Client) ListCustomFields(params *ListCustomFieldsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ListCustomFieldsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewListCustomFieldsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "listCustomFields",
		Method:             "GET",
		PathPattern:        "/api/v3/custom-fields",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &ListCustomFieldsReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*ListCustomFieldsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for listCustomFields: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
SearchIterations searches iterations

Search Iterations lets you search Iterations based on desired parameters. Since ordering of results can change over time (due to search ranking decay, new Iterations being created), the `next` value from the previous response can be used as the path and query string for the next page to ensure stable ordering.
*/
func (a *Client) SearchIterations(params *SearchIterationsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*SearchIterationsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewSearchIterationsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "searchIterations",
		Method:             "GET",
		PathPattern:        "/api/v3/search/iterations",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &SearchIterationsReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*SearchIterationsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for searchIterations: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}

/*
SearchMilestones searches milestones

Search Milestones lets you search Milestones based on desired parameters. Since ordering of results can change over time (due to search ranking decay, new Milestones being created), the `next` value from the previous response can be used as the path and query string for the next page to ensure stable ordering.
*/
func (a *Client) SearchMilestones(params *SearchMilestonesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*SearchMilestonesOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewSearchMilestonesParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "searchMilestones",
		Method:             "GET",
		PathPattern:        "/api/v3/search/milestones",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &SearchMilestonesReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*SearchMilestonesOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for searchMilestones: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
*/
func (a *Client) UpdateCustomField(params *UpdateCustomFieldParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateCustomFieldOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
	...
	success, ok := result.(*UpdateCustomFieldOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for updateCustomField: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
