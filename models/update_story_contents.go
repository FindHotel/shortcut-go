...
func (m *UpdateStoryContents) validateCustomFields(formats strfmt.Registry) error {
...
func (m *UpdateStoryContents) contextValidateCustomFields(ctx context.Context, formats strfmt.Registry) error {
