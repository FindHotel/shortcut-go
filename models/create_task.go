...
func (m *CreateTask) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *CreateTask) validateDescription(formats strfmt.Registry) error {
...
func (m *CreateTask) validateOwnerIds(formats strfmt.Registry) error {
...
func (m *CreateTask) validateUpdatedAt(formats strfmt.Registry) error {
