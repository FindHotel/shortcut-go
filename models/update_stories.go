...
type UpdateStories struct {
	...
	// A map specifying a CustomField ID and CustomFieldEnumValue ID that represents an assertion of some value for a CustomField.
	CustomFieldsRemove []*CustomFieldValueParams `json:"custom_fields_remove"`
...
func (m *UpdateStories) validateCustomFieldsAdd(formats strfmt.Registry) error {
...
func (m *UpdateStories) validateCustomFieldsRemove(formats strfmt.Registry) error {
...
func (m *UpdateStories) contextValidateCustomFieldsAdd(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UpdateStories) contextValidateCustomFieldsRemove(ctx context.Context, formats strfmt.Registry) error {
