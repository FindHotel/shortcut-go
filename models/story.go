...
func (m *Story) validateCustomFields(formats strfmt.Registry) error {
...
func (m *Story) validateGlobalID(formats strfmt.Registry) error {
...
func (m *Story) contextValidateCustomFields(ctx context.Context, formats strfmt.Registry) error {
