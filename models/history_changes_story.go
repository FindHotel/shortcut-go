...
func (m *HistoryChangesStory) validateCustomFieldValueIds(formats strfmt.Registry) error {
	if swag.IsZero(m.CustomFieldValueIds) { // not required
		return nil
	}

	if m.CustomFieldValueIds != nil {
		if err := m.CustomFieldValueIds.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("custom_field_value_ids")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("custom_field_value_ids")
			}
			return err
		}
	}
...
func (m *HistoryChangesStory) validateGroupID(formats strfmt.Registry) error {
	...
	if m.GroupID != nil {
		if err := m.GroupID.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("group_id")
			}
			return err
		}
	}
...
func (m *HistoryChangesStory) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateCustomFieldValueIds(ctx, formats); err != nil {
		res = append(res, err)
	}
