...
func (m *HistoryReferenceLabel) validateAppURL(formats strfmt.Registry) error {
...
func (m *HistoryReferenceLabel) validateEntityType(formats strfmt.Registry) error {
...
func (m *HistoryReferenceLabel) validateID(formats strfmt.Registry) error {
...
func (m *HistoryReferenceLabel) validateName(formats strfmt.Registry) error {
