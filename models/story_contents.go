...
func (m *StoryContents) validateCustomFields(formats strfmt.Registry) error {
...
func (m *StoryContents) contextValidateCustomFields(ctx context.Context, formats strfmt.Registry) error {
