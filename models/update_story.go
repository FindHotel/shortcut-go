...
func (m *UpdateStory) validateCustomFields(formats strfmt.Registry) error {
...
func (m *UpdateStory) contextValidateCustomFields(ctx context.Context, formats strfmt.Registry) error {
